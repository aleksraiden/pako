 ...
 * Version: 1.0 LastModified: Dec 25 1999
 * This library is free.  You can redistribute it and/or modify it.
 */
Inflate.prototype.Utf8ArrayToStr = function(array) {
	var out, i, len, c;
	var char2, char3;
 ...
 * - encodeResult (Boolean) - encode result to utf8 string
 *
 *
 * ##### Example:
 *
...
function inflate(input, options) {
  //if browser not native support Uint8Array
  if (typeof(Uint8Array) != 'function') throw 'Native Uint8Array (typed array) support needed!';
  ...
  if (options.encodeResult)
    inflator.result = inflator.Utf8ArrayToStr( inflator.result );
